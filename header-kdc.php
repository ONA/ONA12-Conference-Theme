...
<body <?php body_class(); ?>>
	...
	<div id="page-wrap"><!-- not needed? up to you: http://camendesign.com/code/developpeurs_sans_frontieres -->
		...
		<header id="header" class="container_12">
			...
			<div id="knight-lead" class="grid_9">
				Knight News<br />
				Challenge: Data</br />
				<span>Winners</span>
			</div>
			
			<div id="header-logo" class="header-content">
			<a href="<?php bloginfo('url'); ?>"><img src="<?php bloginfo('stylesheet_directory');  ?>/img/ONA12logobackground.png" class="header-logo" /></a>
			</div>
		</header>
